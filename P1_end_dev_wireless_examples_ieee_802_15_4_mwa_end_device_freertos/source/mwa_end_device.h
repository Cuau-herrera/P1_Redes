...
/* Equipo 7, nodo End Device - debe ser distinta a la del Coordinador */
#define mMacExtendedAddress_c      (0x0000000000070002ULL)
...
#else
  /* Canal fijo para el Equipo 7: solo escanear el canal 11 */
  #define mDefaultValueOfChannel_c (1 << 11)
#endif
...
/* Fase 1: timer de 4s del contador, y evento de override por switch */
#define gAppEvtCounterTimerExpired_c   (1 << 5)
#define gAppEvtSwitchOverride_c        (1 << 6)
